...
export default function FeaturesGrid() {
  return (
    <div className="p-6 w-[min(1398px,93%)] rounded-[40px] bg-white mx-auto sm:translate-y-[-22%] shadow-[0px_10px_40px_0px_#0000001A]">
      <div className="grid grid-cols-2 divide-border-middle sm:grid-cols-6 [clip-path:inset(1px_0_0_2px)] divide-x divide-y">
        ...
        <FeatureCard icon={<IoIosTimer size={32}  />} title="قیمت‌گذاری لحظه‌ای و شفاف" className="border-b" />
      </div>
    </div>
  );
}
